...
{    
    ...
    public class MapperTests
    {
        ...
        public async Task UsesMapping()
        {
            ...
            byte[] tinkoffDump = tEncoding.GetBytes(
                "header line\n" +
                "\"01.01.2015 00:00:00\";\"01.01.2015\";\"*1111\";\"OK\";\"-100\";\"RUB\";\"-100,09\";\"RUB\";\"\";\"Тестовая категория1\";\"\";\"комментарий1\";\"0,00\";\"0,00\";\"200,00\"\n"+
                "\"02.01.2015 00:00:00\";\"02.01.2015\";\"*1111\";\"OK\";\"-200\";\"RUB\";\"-200,09\";\"RUB\";\"\";\"Тестовая категория2\";\"\";\"комментарий2\";\"0,00\";\"0,00\";\"300,00\"\n"+
                "\"03.01.2015 00:00:00\";\"03.01.2015\";\"*1111\";\"OK\";\"-300\";\"RUB\";\"-300,09\";\"RUB\";\"\";\"Тестовая категория3\";\"\";\"комментарий3\";\"0,00\";\"0,00\";\"400,00\""
            );
            td.Setup(f => f.OpenRead())
                .Returns(new MemoryStream(tinkoffDump));
